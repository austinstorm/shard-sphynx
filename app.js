...
app.get('/brands/add', brandController.getAddBrand);
app.post('/brands/add', brandController.postAddBrand);

/**
 * Company routes.
 */
app.get('/companies', companyController.getCompanies);
app.get('/companies/add', companyController.getAddCompany);
app.post('/companies/add', companyController.postAddCompany);
app.get('/companies/:RN', companyController.getViewCompany);
